      ...
      <div className="md:flex min-h-screen bg-[#242529] md:bg-transparent">
        ...
        <div className="flex flex-col justify-center items-center w-full md:w-3/5 px-6 md:px-20 lg:px-32 py-10 gap-6">
          ...
          <div className="w-full max-w-lg flex flex-col gap-2">
            <label className="text-[#F5F5F5] text-lg">Name</label>
            <div className="flex">
              <input
                type="text"
                placeholder="Name"
                className="w-full h-14 bg-[#35373B] text-white px-4 rounded-xl outline-none"
              />
            </div>
          </div>
          ...
          <div className="w-full max-w-lg flex flex-col gap-2">
            <label className="text-[#F5F5F5] text-lg">Confirm Password</label>
            <div className="flex">
              <div className="bg-[#35373B] h-14 rounded-l-xl px-4 flex items-center">
                <MdLockOutline className="text-2xl text-white/30" />
              </div>
          ...
          <Link
            to="/"
            className="w-full py-3.5 text-center max-w-lg h-14 my-3 bg-[#FF7200] text-white text-xl rounded-xl"
          >
            SIGNUP
          </Link>
